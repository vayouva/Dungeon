...
/**
 * @author abassi_youva
 * Main class, no need to explain it ;)
 */
public class Main {
    public static void main( String[] args ) {
    		...
    		Room room8 = new Room(monster_mid3, strengthPotion);
    		Room room9 = new Exit(monster_insane, bandito);
